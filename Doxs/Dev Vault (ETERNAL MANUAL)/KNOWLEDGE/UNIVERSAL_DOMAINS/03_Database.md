...
- [Expand-Contract Pattern 2](#expand-contract-pattern-2)
...
- [Normalization vs Denormalization 2](#normalization-vs-denormalization-2)
...
- [Batch Operations 2](#batch-operations-2)
...
- [Deferrable Constraints 2](#deferrable-constraints-2)
...
- [Row Level Security 2](#row-level-security-2)
- [Real-time Subscriptions 2](#real-time-subscriptions-2)
- [DRIZZLE ORM PATTERNS 2](#drizzle-orm-patterns-2)
- [Schema Definition 2](#schema-definition-2)
- [Queries 3](#queries-3)
- [Relations](#relations)
- [DATABASE INDEXES](#database-indexes)
- [When to Index](#when-to-index)
- [Index Types 2](#index-types-2)
...
- [REDIS PRODUCTION PATTERNS 2](#redis-production-patterns-2)
- [Cache-Aside Pattern 2](#cache-aside-pattern-2)
...
- [The command that destroyed GitLab 2](#the-command-that-destroyed-gitlab-2)
- [Was on PRODUCTION](#was-on-production)
- [300GB gone in seconds 2](#300gb-gone-in-seconds-2)
- [5,000+ projects affected 2](#5000-projects-affected-2)
...
- [pgbouncer.ini 2](#pgbouncerini-2)
...
- [VIBE: Direct connection per request 2](#vibe-direct-connection-per-request-2)
...
- [Formula: pool_size = (num_pods*connections_per_pod) / max_db_connections*0.8](#formula-poolsize--numpodsconnectionsperpod--maxdbconnections08)
...
- [pgbouncer.ini 3](#pgbouncerini-3)
...
- [Connection limits 2](#connection-limits-2)
...
- [Try cache first 2](#try-cache-first-2)
...
- [SLOW QUERIES](#slow-queries)
  - [The Symptom 2 2](#the-symptom-2-2)
...
- [CONNECTION POOL EXHAUSTION 2](#connection-pool-exhaustion-2)
  - [The Symptom 3](#the-symptom-3)
  - [Why This Happens 2](#why-this-happens-2)
  - [Real Fixes 6](#real-fixes-6)
  - [Fix 1: Singleton Client Pattern 2](#fix-1-singleton-client-pattern-2)
  - [Fix 2: Serverless Connection Pattern 2](#fix-2-serverless-connection-pattern-2)
...
- [REALTIME SUBSCRIPTIONS STOP WORKING WITH RLS](#realtime-subscriptions-stop-working-with-rls)
  ...
  - [Why This Happens 3](#why-this-happens-3)
...
- [Query Optimization 2](#query-optimization-2)
- [Connection Pooling with PgBouncer](#connection-pooling-with-pgbouncer)
- [pgbouncer.ini 4](#pgbouncerini-4)
...
- [?? MIGRATION PATTERNS 2](#-migration-patterns-2)
- [??? ORM PATTERNS 2](#-orm-patterns-2)
- [?? SEARCH IMPLEMENTATION 2](#-search-implementation-2)
- [?? TIME-SERIES DATA 2](#-time-series-data-2)
- [?? MULTI-TENANT PATTERNS 2](#-multi-tenant-patterns-2)
- [??? SOFT DELETE PATTERNS 2](#-soft-delete-patterns-2)
- [??? JSONB PATTERNS (PostgreSQL) 2](#-jsonb-patterns-postgresql-2)
- [?? DRIZZLE ORM PATTERNS 2](#-drizzle-orm-patterns-2)
- [? PRISMA ADVANCED PATTERNS 2](#-prisma-advanced-patterns-2)
- [??? CONNECTION POOL TUNING 2](#-connection-pool-tuning-2)
- [??? POSTGRES EXPLAIN ANALYZE 2](#-postgres-explain-analyze-2)
- [??? DATABASE BACKUP STRATEGIES 2](#-database-backup-strategies-2)
- [??? QUERY OPTIMIZATION PATTERNS 2](#-query-optimization-patterns-2)
- [??? DATABASE REPLICATION PATTERNS 2](#-database-replication-patterns-2)
- [??? MONGODB PATTERNS 2](#-mongodb-patterns-2)
- [??? DATABASE TIER 1 - ADVANCED PATTERNS 2](#-database-tier-1---advanced-patterns-2)
- [??? REDIS CLUSTERING 2](#-redis-clustering-2)
- [??? FULL-TEXT SEARCH IN POSTGRESQL 2](#-full-text-search-in-postgresql-2)
- [??? POSTGRES ADVANCED FEATURES 2](#-postgres-advanced-features-2)
- [??? DATABASE MIGRATION STRATEGIES 2](#-database-migration-strategies-2)
- [??? DATA MODELING PATTERNS 2](#-data-modeling-patterns-2)
- [??? QUERY PATTERNS FOR SCALE 2](#-query-patterns-for-scale-2)
- [??? DATABASE PERFORMANCE DEBUGGING 2](#-database-performance-debugging-2)
- [??? DATABASE CONCURRENCY PATTERNS 2](#-database-concurrency-patterns-2)
- [??? POSTGRES EXTENSIONS 2](#-postgres-extensions-2)
- [??? DATABASE HIGH AVAILABILITY 2](#-database-high-availability-2)
- [??? DATABASE QUERY ANTI-PATTERNS 2](#-database-query-anti-patterns-2)
- [??? PRISMA PERFORMANCE OPTIMIZATION 2](#-prisma-performance-optimization-2)
- [??? DATABASE CONNECTION TROUBLESHOOTING 2](#-database-connection-troubleshooting-2)
- [??? REDIS USE CASES 2](#-redis-use-cases-2)
- [??? TRANSACTION PATTERNS 2](#-transaction-patterns-2)
- [??? DATABASE ANTI-PATTERNS 2](#-database-anti-patterns-2)
- [??? POSTGRES CONFIGURATION TUNING 2](#-postgres-configuration-tuning-2)
- [??? POSTGRES JSON OPERATORS 2](#-postgres-json-operators-2)
- [??? DATABASE CONSTRAINTS 2](#-database-constraints-2)
- [??? DATABASE TRIGGER PATTERNS 2](#-database-trigger-patterns-2)
- [??? SQL WINDOW FUNCTIONS DEEP DIVE 2](#-sql-window-functions-deep-dive-2)
- [??? DATABASE STORED PROCEDURES 2](#-database-stored-procedures-2)
- [??? DATABASE REPLICATION LAG 2](#-database-replication-lag-2)
- [??? BATCH PROCESSING PATTERNS 2](#-batch-processing-patterns-2)
- [??? DATABASE VIEWS 2](#-database-views-2)
- [??? QUERY DEBUGGING PATTERNS 2](#-query-debugging-patterns-2)
- [??? POSTGRES ROW LEVEL SECURITY 2](#-postgres-row-level-security-2)
- [??? DATABASE FOREIGN KEY STRATEGIES 2](#-database-foreign-key-strategies-2)
- [??? DATABASE ENUM PATTERNS 2](#-database-enum-patterns-2)
- [??? SUPABASE PRODUCTION PATTERNS 2](#-supabase-production-patterns-2)
- [??? TIME-SERIES DATA PATTERNS 2](#-time-series-data-patterns-2)
- [Explain Analyze 2 2](#explain-analyze-2-2)
- [1 query PER file 2](#1-query-per-file-2)
- [Result: 2 queries = 200ms 2](#result-2-queries--200ms-2)
- [Single query with JOIN - even faster 2](#single-query-with-join---even-faster-2)
- [Connection NEVER returned if exception 2](#connection-never-returned-if-exception-2)
- [DEADLOCK 2](#deadlock-2)
- [If another transfer runs (to_user from_user) = DEADLOCK 2](#if-another-transfer-runs-touser-fromuser--deadlock-2)
- [No deadlock possible - both transactions lock in same order 2](#no-deadlock-possible---both-transactions-lock-in-same-order-2)
- [The command that destroyed GitLab 2 2](#the-command-that-destroyed-gitlab-2-2)
- [... bulk index 2](#-bulk-index-2)
- [RACE: Another request runs between SELECT and UPDATE 2](#race-another-request-runs-between-select-and-update-2)
...
- [With 15 pods and 100 max connections: 100 / 15 * 0.8 5 per pod 2](#with-15-pods-and-100-max-connections-100--15-08-5-per-pod-2)
- [What if this fails? Order exists, inventory not updated 2](#what-if-this-fails-order-exists-inventory-not-updated-2)
- [3) (integer) 1500000  <- 1.5 seconds 2](#3-integer-1500000---15-seconds-2)
...
## The command that destroyed GitLab 2

rm -rf /var/opt/gitlab/postgresql/data  # Thought was on replica

## Was on PRODUCTION

## 300GB gone in seconds 2

## 5,000+ projects affected 2
...
## VIBE: Direct connection per request 2
...
+- Table grew past planner thresholds
    ...
    ### Fix 1: Singleton Client Pattern 2
    ...
    ### Fix 2: Serverless Connection Pattern 2
...
### END OF DATABASE PATTERNS
    ...
    ## ?? MULTI-TENANT PATTERNS 2
    
    > **The patterns for SaaS architecture**
    
    ---
    
    ## ??? SOFT DELETE PATTERNS 2
    
    > **The safe deletion strategies**
    
    ---
    
    ## ??? JSONB PATTERNS (PostgreSQL) 2
    ...
    ## ? PRISMA ADVANCED PATTERNS 2
    
    > **The ORM patterns beyond basics**
    
    ---
    
    ## ??? CONNECTION POOL TUNING 2
    
    > **The patterns for optimal database connections**
    
    ---
    
    ## ??? POSTGRES EXPLAIN ANALYZE 2
    
    > **The query analysis patterns**
    
    ---
    
    ## ??? DATABASE BACKUP STRATEGIES 2
    ...
    ## ??? DATABASE REPLICATION PATTERNS 2
    ...
    ## ??? DATABASE TIER 1 - ADVANCED PATTERNS 2
    ...
    ## ??? FULL-TEXT SEARCH IN POSTGRESQL 2
    
    > **The native search patterns**
    
    ---
    
    ## ??? POSTGRES ADVANCED FEATURES 2
    
    > **The power user patterns**
    
    ---
    
    ## ??? DATABASE MIGRATION STRATEGIES 2
    
    > **The zero-downtime migration patterns**
    
    ---
    
    ## ??? DATA MODELING PATTERNS 2
    
    > **The schema design patterns**
    
    ---
    
    ## ??? QUERY PATTERNS FOR SCALE 2
    
    > **The high-volume query patterns**
    
    ---
    
    ## ??? DATABASE PERFORMANCE DEBUGGING 2
    
    > **The slow query investigation patterns**
    
    ---
    
    ## ??? DATABASE CONCURRENCY PATTERNS 2
    ...
    ## ??? DATABASE HIGH AVAILABILITY 2
    
    > **The production resilience patterns**
    
    ---
    
    ## ??? DATABASE QUERY ANTI-PATTERNS 2
    
    > **The queries that kill performance**
    
    ---
    
    ## ??? PRISMA PERFORMANCE OPTIMIZATION 2
    
    > **The ORM performance patterns**
    
    ---
    
    ## ??? DATABASE CONNECTION TROUBLESHOOTING 2
    ...
    ## ??? POSTGRES CONFIGURATION TUNING 2
    
    > **The performance configuration patterns**
    
    ---
    
    ## ??? POSTGRES JSON OPERATORS 2
    ...
    ## ??? DATABASE TRIGGER PATTERNS 2
    
    > **The automated database logic**
    
    ---
    
    ## ??? SQL WINDOW FUNCTIONS DEEP DIVE 2
    
    > **The advanced analytics patterns**
    
    ---
    
    ## ??? DATABASE STORED PROCEDURES 2
    
    > **The database-side logic patterns**
    
    ---
    
    ## ??? DATABASE REPLICATION LAG 2
    ...
    ## ??? QUERY DEBUGGING PATTERNS 2
    
    > **The SQL investigation patterns**
    
    ---
    
    ## ??? POSTGRES ROW LEVEL SECURITY 2
    
    > **The tenant isolation patterns**
    
    ---
    
    ## ??? DATABASE FOREIGN KEY STRATEGIES 2
    
    > **The referential integrity patterns**
    
    ---
    
    ## ??? DATABASE ENUM PATTERNS 2
    
    > **The controlled value patterns**
    
    ---
    
    ## ??? SUPABASE PRODUCTION PATTERNS 2
    
    > **The patterns for Supabase at scale**
    
    ---
    
    ## ??? TIME-SERIES DATA PATTERNS 2
...
-- "Index Scan using idx_user_email"
    ...
    ## Result: 2 queries = 200ms 2
    

## Single query with JOIN - even faster 2

    
    ---
    
    ## Connection NEVER returned if exception 2
    ...
    ## If another transfer runs (to_user from_user) = DEADLOCK 2
    
    ## No deadlock possible - both transactions lock in same order 2
    

---

## The command that destroyed GitLab 2 2
...
"index": { "refresh_interval": "1s" }
    ...
    ## RACE: Another request runs between SELECT and UPDATE 2
    await db.execute(
    "UPDATE events SET tickets_remaining = $1 WHERE id = $2",
    event['tickets_remaining'] - 1, event_id
            )
...
## With 15 pods and 100 max connections: 100 / 15 * 0.8 5 per pod 2
...
## What if this fails? Order exists, inventory not updated 2

return order

    
    ## 3) (integer) 1500000  <- 1.5 seconds 2
