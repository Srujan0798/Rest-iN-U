...
- [Analytics 2](#analytics-2)
  - [END OF ULTRA IOT EXPANSION 2](#end-of-ultra-iot-expansion-2)
...
- [include "esp_ota_ops.h" 2](#include-espotaopsh-2)
...
- [? TITAN: Production MQTT client with exponential backoff 2](#-titan-production-mqtt-client-with-exponential-backoff-2)
- [? TITAN: High-throughput InfluxDB ingestion 2](#-titan-high-throughput-influxdb-ingestion-2)
- [? TITAN: Edge device with offline-first architecture 2](#-titan-edge-device-with-offline-first-architecture-2)
