...
import propertiesSearchRoutes from "./properties-search";
...
router.get("/", (req, res) => {
  res.json({
    ...
    version: "1.0.0",
    description:
      "Revolutionary real estate platform combining 5,000 years of Vedic wisdom with modern technology",
    features: {
      core: "Authentication, Properties, Search, Agents, Favorites, Messages, Documents, Calendar",
      ancientWisdom:
        "Vastu Shastra, Vedic Astrology, Five Elements, Numerology, Sacred Geometry, Muhurat",
      climate:
        "Climate Risk, Air Quality, Water Quality, Noise, EMF, Carbon Footprint, Solar Potential",
      blockchain:
        "Property NFTs, Fractional Ownership, DAO Governance, Smart Contracts",
      iot: "IoT Monitoring, Smart Home, Health Tracking, Video Streaming, Virtual Tours",
      location:
        "Neighborhoods, Schools, Commute, Crime Stats, Accessibility, Community",
      financial:
        "Mortgage Calculator, Insurance, Valuation, Investment Analysis, Payments",
      agentTools:
        "CRM, Leads, Showings, Open Houses, Inspections, Reports, Reviews",
    },
    endpoints: {
      // Core
...
router.use("/properties-search", propertiesSearchRoutes);
